...
<div class="container-fluid p-0">
    <nav class="navbar navbar-expand-lg fixed-top logo">
        ...
        <a class="navbar-brand slide-section"  href="#pocetna">
   ...
   viewBox="0 0 601.25 138.75"><g
     ...
     transform="matrix(1.25,0,0,-1.25,0,138.75)"><g
       ...
       transform="matrix(0.12838229,0,0,0.12838229,-68.259408,-15.752171)"><g
        ...
        <button class="navbar-toggler visible-lg-block" data-toggle="collapse" data-target="#navbarMenu">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p class="">Nova-101 37 <br>21203 <br>Veternik <br>Srbija</p>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p class="adresa">Tenis@gmail.com</p>
                    </div>
                </div>
